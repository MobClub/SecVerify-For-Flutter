...
SecVerifyUIConfigIOSCustomView _$SecVerifyUIConfigIOSCustomViewFromJson(
  ...
  return SecVerifyUIConfigIOSCustomView(
    ...
    ..ivCornerRadius = (json['ivCornerRadius'] as num?)?.toDouble()
    ..btnTitle = json['btnTitle'] as String?
    ..btnBgColor = json['btnBgColor'] as String?
    ..btnTitleColor = json['btnTitleColor'] as String?
    ..btnTitleFont = (json['btnTitleFont'] as num?)?.toDouble()
    ..btnImages =
        (json['btnImages'] as List<dynamic>?)?.map((e) => e as String).toList()
    ..btnBorderWidth = (json['btnBorderWidth'] as num?)?.toDouble()
    ..btnBorderColor = json['btnBorderColor'] as String?
    ..btnBorderCornerRadius =
        (json['btnBorderCornerRadius'] as num?)?.toDouble()
    ..labelText = json['labelText'] as String?
    ..labelTextColor = json['labelTextColor'] as String?
    ..labelFont = (json['labelFont'] as num?)?.toDouble()
...
SecVerifyUIConfigIOSPrivacyCheckBoxLayout
  ...
  return SecVerifyUIConfigIOSPrivacyCheckBoxLayout()
    ..layoutTop = (json['layoutTop'] as num?)?.toDouble()
    ..layoutRight = (json['layoutRight'] as num?)?.toDouble()
    ..layoutCenterY = (json['layoutCenterY'] as num?)?.toDouble()
    ..layoutWidth = (json['layoutWidth'] as num?)?.toDouble()
    ..layoutHeight = (json['layoutHeight'] as num?)?.toDouble();
}
